        ...
        <div class="flex flex-col w-full font-medium">
          ...
          <div>
            <span class="select-none flex items-center px-4 py-[.775rem] cursor-pointer my-[.4rem] rounded-[.95rem]">
              ...
              <a href="" class="flex items-center flex-grow text-[1.15rem] dark:text-black-400/75 text-black-500 hover:text-dark">clients</a>
            </span>
          </div>
          <!-- menu item -->
          <div>
            <span class="select-none flex items-center px-4 py-[.775rem] cursor-pointer my-[.4rem] rounded-[.95rem]">
              ...
              <a href="" class="flex items-center flex-grow text-[1.15rem] dark:text-black-400/75 text-black-500 hover:text-dark">accounts</a>
            </span>
          </div>
          <!-- menu item -->
          <div>
            <span class="select-none flex items-center px-4 py-[.775rem] cursor-pointer my-[.4rem] rounded-[.95rem]">
              ...
              <a href="" class="flex items-center flex-grow text-[1.15rem] dark:text-black-400/75 text-black-500 hover:text-dark">transactions</a>
            </span>
          </div>
          <!-- menu item -->
          <div>
            <span class="select-none flex items-center px-4 py-[.775rem] cursor-pointer my-[.4rem] rounded-[.95rem]">
              ...
              <a href="" class="flex items-center flex-grow text-[1.15rem] dark:text-black-400/75 text-black-500 hover:text-dark">agencies</a>
            </span>
          </div>
          <!-- menu item -->
          <div>
            <span class="select-none flex items-center px-4 py-[.775rem] cursor-pointer my-[.4rem] rounded-[.95rem]">
              ...
              <a href="" class="flex items-center flex-grow text-[1.15rem] dark:text-black-400/75 text-black-500 hover:text-dark">bank counters</a>
            </span>
          </div>
          <!-- menu item -->
          <div>
          ...
          <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody><tr class="border-b dark:border-gray-700">
                  ...
                  <td class="px-4 py-3"> <?= $row['adresse'] ?> </td>
                  <td class="px-4 py-3"> <?= $row['agence'] ?> </td>
