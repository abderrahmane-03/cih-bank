    ...
    <div class="container flex mx-auto bg-white">
        ...
        <aside
            ...
            <div class="flex shrink-0 px-8 items-center justify-between h-[60px]">
                <P>CIH</P> <a class="flex transition-colors duration-200 ease-in-out">
                ...
                <div class="flex items-center mr-5">
                    <div class="mr-5">
                        <div class="inline-block relative shrink-0 cursor-pointer rounded-[.95rem]">
                            <img class="w-[50px] h-[35px] shrink-0 inline-block rounded-[.95rem]" src="adm.jpg"
                                alt="avatar image">
                        </div>
                    </div>
                    <div class="mr-2 ">
                        <a
                            class="dark:hover:text-primary hover:text-primary transition-colors duration-200 ease-in-out text-[1.075rem] font-medium dark:text-black-400/90 text-secondary-inverse">El
                            hafidi abderrahmane</a>
                        <span
            ...
            <div class="flex flex-col w-full font-medium">
                ...
                <div>
                    <span
                        ...
                        </svg><a href="clientdashboard.php"
                ...
                <div>
                    <span
                        ...
                        </svg><a href="clientdashboardtransaction.php"
